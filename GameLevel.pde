...
/*********************************************/
// make count 3
class StartCount extends GameLevel
{
  Count3 count3;

  StartCount(PApplet applet)
  {
    super(applet);
    gameState = GameState.NotRunning;
  }
  ...
  void start()
  {
    count3 = new Count3(applet, width/2, height/2, this);
    gameState = GameState.Running;
  }
...
class StartCount2 extends GameLevel
{
  Count2 count2;

  StartCount2(PApplet applet)
  {
    super(applet);
    gameState = GameState.NotRunning;
  }
  ...
  void start()
  {
    count2 = new Count2(applet, width/2, height/2, this);
    gameState = GameState.Running;
  }
...
class StartCount1 extends GameLevel
{
  Count1 count1;

  StartCount1(PApplet applet)
  {
    super(applet);
    gameState = GameState.NotRunning;
  }
  ...
  void start()
  {
    count1 = new Count1(applet, width/2, height/2, this);
    gameState = GameState.Running;
  }
...
class ImpossibleLevel extends GameLevel
{
  ImpButton Impbutton;

  ImpossibleLevel(PApplet applet)
  {
    super(applet);
    gameState = GameState.NotRunning;
  }
  ...
  void start()
  {
    Impbutton = new ImpButton(applet, 30, 50, this);
    gameState = GameState.Running;
  }
