...
class AsteroidsLevel3 extends GameLevel 
{
  Ship ship;
  ...
  void start()
  {
    ...
    asteroids.add(new BigAsteroid(applet, 200, 500, 0, 0.02, 100, PI*.5));
    asteroids.add(new BigAsteroid(applet, 500, 200, 1, -0.01, 100, PI*1));
    asteroids.add(new BigAsteroid(applet, 100, 300, 2, 0.01, 100, PI*1.7));
    asteroids.add(new BigAsteroid(applet, 500, 600, 0, -0.02, 100, PI*1.3));
    asteroids.add(new BigAsteroid(applet, 600, 100, 2, 0.01, 100, PI*.1));
    asteroids.add(new BigAsteroid(applet, 600, 300, 0, -0.02, 100, PI*.2));
